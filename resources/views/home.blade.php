...
<div class="row justify-content-center">
	<div class="col-md-12">
		<div class="card">
			...
			<div class="card-body">
				<h5>Hola <strong>{{ Auth::user()->name }},</strong> {{ __('Estas navegando en ') }}{{ config('app.name', 'Software_Peliculas') }}</h5>
				</br> 
				<hr>
			...
			<div class="row w-100">
					...
					<div class="col-md-3">
						<div class="card border-blue mx-sm-1 p-3">
					...
					<div class="col-md-3">
						...
						<div class="card border-warning mx-sm-1 p-3">
							<div class="card border-warning text-warning p-3 my-card" ><span class="text-center fa fa-users" aria-hidden="true"></span></div>
							<div class="text-warning text-center mt-3"><h4>Directores</h4></div>
							<div class="text-warning text-center mt-2"><h1>{{ Auth::user()->count() }}</h1></div>
						</div>
